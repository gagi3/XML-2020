...
public class ResenjeZahtevOdbijen {
    ...
    protected ResenjeZahtevOdbijen.DateMetadata dateMetadata;
    @XmlElement(namespace = "http://www.pijz.rs/resenje-zahtev-odbijen", required = true)
     ...
     * @return
     *     possible object is
     *     {@link ResenjeZahtevOdbijen.DateMetadata }
     *     
     */
    public ResenjeZahtevOdbijen.DateMetadata getDateMetadata() {
        return dateMetadata;
    }
     ...
     *     
     */
    public void setDateMetadata(ResenjeZahtevOdbijen.DateMetadata value) {
    ...
    public static class DateMetadata {
        ...
        @XmlElement(name = "datum_obavestenja", namespace = "http://www.pijz.rs/resenje-zahtev-odbijen", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar datumObavestenja;
        @XmlElement(name = "datum_zahteva", namespace = "http://www.pijz.rs/resenje-zahtev-odbijen", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar datumZahteva;
        @XmlElement(name = "datum_zalbe", namespace = "http://www.pijz.rs/resenje-zahtev-odbijen", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar datumZalbe;
        @XmlElement(name = "datum_postupka", namespace = "http://www.pijz.rs/resenje-zahtev-odbijen", required = true)
        @XmlSchemaType(name = "date")
