...
import rs.pijz.server.poverenik.soap.request.zalba_cutanje.GetZalbaCutanjeRequest;
import rs.pijz.server.poverenik.soap.response.zalba_cutanje.GetZalbaCutanjeResponse;
