...
import rs.pijz.server.sluzbenik.soap.communication.resenje.SendResenjeGradjaninRequest;
import rs.pijz.server.sluzbenik.soap.communication.resenje.SendResenjeGradjaninResponse;
import rs.pijz.server.sluzbenik.soap.communication.resenje.SendResenjeSluzbenikRequest;
...
public class ResenjeClient extends WebServiceGatewaySupport {
	...
	private static String WSDL_URL = "http://localhost:8082/ws/resenje-soap.wsdl";
